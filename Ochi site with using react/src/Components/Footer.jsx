...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-zinc-900 font-["Founders_Grotesk_X-Condensed"] p-20 sticky z-2 flex'>
      <div className="w-1/2 h-full flex justify-between flex-col ">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold leading-none -mb-7 uppercase">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold leading-none -mb-7 uppercase">
            Opening
